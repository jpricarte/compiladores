...
{
       0,   117,   117,   117,   145,   146,   157,   158,   161,   176,
     177,   179,   196,   214,   217,   223,   223,   283,   284,   285,
     287,   302,   305,   306,   318,   319,   320,   321,   322,   323,
     326,   326,   331,   332,   333,   334,   338,   339,   347,   359,
     377,   377,   414,   415,   424,   434,   452,   452,   474,   475,
     484,   494,   512,   512,   534,   535,   544,   553,   571,   571,
     594,   611,   635,   652,   653,   656,   656,   684,   685,   686,
     696,   717,   734,   758,   782,   783,   808,   809,   835,   836,
     878,   921,   922,   958,   994,  1030,  1068,  1069,  1104,  1139,
    1140,  1174,  1208,  1233,  1234,  1235,  1245,  1256,  1262,  1276,
    1279,  1290,  1301,  1312,  1323,  1335,  1336,  1337,  1338
};
#endif
...
#line 117 "parser.y"
            ...
            for (auto command : (yyvsp[0].valor_lexico)->iloc_code_element.code) {
                code.push_back(command);
            }
            // TODO: DAR PUSH BACK DUM HALT=
            code.push_back(Command{end, Instruct::NOP});
            (yyvsp[0].valor_lexico)->iloc_code_element.code = code;
            arvore = (yyval.valor_lexico);
            symbol_table_stack.pop();
	    FCG fcg;
	    fcg.fromILOC((yyval.valor_lexico)->iloc_code_element.code);
...
#line 146 "parser.y"
                ...
                if ((yyval.valor_lexico) != nullptr ) {
                    ...
                    if ((yyvsp[0].valor_lexico) != nullptr)
                        (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                } else {
                    (yyval.valor_lexico) = (yyvsp[0].valor_lexico);
                }
            }
...
#line 179 "parser.y"
                                {   if (symbol_table_stack.is_declared((yyvsp[0].valor_lexico)->get_token_val())) {
                                    ...
                                    x86::define_global_int(get<std::string>((yyvsp[0].valor_lexico)->get_token_val()));
...
#line 240 "parser.y"
                         { 
                (yyval.valor_lexico) = (yyvsp[-5].valor_lexico); 
                (yyval.valor_lexico)->add_child((yyvsp[0].valor_lexico));
                lab_t func_label = get_new_label();
                if (get<std::string>((yyval.valor_lexico)->get_token_val()) == "main") {
                    main_label = func_label;
                    main_token_val = (yyval.valor_lexico)->get_token_val();
                }
                label_memory.insert({(yyval.valor_lexico)->get_token_val(), func_label});

                (yyval.valor_lexico)->iloc_code_element.code.push_back(Command{func_label, Instruct::NOP});
                auto temp = get_new_register();
                auto n_val = get_new_register();
                (yyval.valor_lexico)->iloc_code_element.code.push_back(Command{Instruct::I2I, RFP, NO_REG, temp, NO_REG});
                (yyval.valor_lexico)->iloc_code_element.code.push_back(Command{Instruct::SUB_I, temp, 4, temp, NO_REG});
                (yyval.valor_lexico)->iloc_code_element.code.push_back(Command{Instruct::LOAD, temp, NO_REG, n_val, NO_REG});
                (yyval.valor_lexico)->iloc_code_element.code.push_back(Command{Instruct::ADD_I, n_val, 2, n_val, NO_REG});
                (yyval.valor_lexico)->iloc_code_element.code.push_back(Command{Instruct::STORE, n_val, NO_REG, temp, NO_REG});
...
*/
                ...
                (yyval.valor_lexico)->iloc_code_element.copy_code(create_return_commands());
...
#line 348 "parser.y"
                   {
                        if ((yyvsp[-2].valor_lexico) != nullptr) {
                            (yyval.valor_lexico) = (yyvsp[-2].valor_lexico); 
                            (yyval.valor_lexico)->add_child((yyvsp[0].valor_lexico));
                            (yyval.valor_lexico)->iloc_code_element.code = (yyvsp[-2].valor_lexico)->iloc_code_element.code;
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                        } else {
                            (yyval.valor_lexico) = (yyvsp[0].valor_lexico);
                        }
...
#line 383 "parser.y"
                    ...
                    auto value = (yyvsp[0].valor_lexico)->iloc_code_element.temporary;
                    // pega endereço de memória da variavel
                    (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::ADD_I, ILOC_Code::RFP, s.desloc, dest, NO_REG));
                    // salva valor nesse endereço de memória
                    (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::STORE, value, NO_REG, dest, NO_REG));
                }
...
#line 594 "parser.y"
                            ...
                            auto dest = (yyvsp[-2].valor_lexico)->iloc_code_element.temporary;
                            auto value = (yyvsp[0].valor_lexico)->iloc_code_element.temporary;
                            (yyval.valor_lexico)->iloc_code_element.code = (yyvsp[-2].valor_lexico)->iloc_code_element.code;
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command{Instruct::STORE, value, NO_REG, dest, NO_REG});
...
#line 611 "parser.y"
                                { 
                                    ...
                                    (yyval.valor_lexico)->iloc_code_element = ILOC_Code::CodeElement{};
                                    (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                                    ...
                                    if (table_id == 0) {
                                        (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::ADD_I, ILOC_Code::RBSS, s.desloc, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
                                    } else {
                                        (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::ADD_I, ILOC_Code::RFP, s.desloc, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
                                    }
                                }
...
#line 669 "parser.y"
                    ...
                    auto func_label = label_memory[(yyvsp[-4].valor_lexico)->get_token_val()];
                    (yyval.valor_lexico) = (yyvsp[-4].valor_lexico); 
                    (yyval.valor_lexico)->set_is_func_call(true); 
                    (yyval.valor_lexico)->add_child((yyvsp[-1].valor_lexico));
                    if ((yyvsp[-1].valor_lexico) != nullptr) {
                        (yyval.valor_lexico)->iloc_code_element.code = (yyvsp[-1].valor_lexico)->iloc_code_element.code;
                    }
                    (yyval.valor_lexico)->iloc_code_element.copy_code(create_call_commands(func_label, func_symbol_table, param_regs.back()));
                    param_regs.pop_back();
                }
...
#line 685 "parser.y"
                              { (yyval.valor_lexico) = (yyvsp[0].valor_lexico); param_regs.back().push_back((yyvsp[0].valor_lexico)->iloc_code_element.temporary);}
...
#line 686 "parser.y"
                                                   {
                        param_regs.back().push_back((yyvsp[-2].valor_lexico)->iloc_code_element.temporary);
                        (yyval.valor_lexico) = (yyvsp[-2].valor_lexico);
                        (yyval.valor_lexico)->add_child((yyvsp[0].valor_lexico));
                        if ((yyvsp[0].valor_lexico) != nullptr) {
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
...
#line 696 "parser.y"
                ...
                (yyval.valor_lexico)->iloc_code_element.code = (yyvsp[0].valor_lexico)->iloc_code_element.code;
                auto temp = get_new_register();
                (yyval.valor_lexico)->iloc_code_element.copy_code({
                    ...
                    Command{Instruct::STORE, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, NO_REG, temp, NO_REG}, // salva o que estiver em $2->iloc_code_element.temporary no endereço do novo reg
                });
                // adiciona o resto do código de retorno
                (yyval.valor_lexico)->iloc_code_element.copy_code(create_return_commands());
                (yyval.valor_lexico)->iloc_code_element.temporary = temp;

                for (auto c : (yyval.valor_lexico)->x86_code_element.code) {
...
#line 717 "parser.y"
								   ...
								   ILOC_Code::CodeElement code_elem = ILOC_Code::CodeElement{};
								    ...
								    code_elem.copy_code((yyvsp[-3].valor_lexico)->iloc_code_element.code);
								    code_elem.code.push_back(Command(Instruct::CBR, (yyvsp[-3].valor_lexico)->iloc_code_element.temporary, NO_REG, code_elem.label_true, code_elem.label_false));
								    code_elem.code.push_back(Command(code_elem.label_true, Instruct::NOP));
								    code_elem.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
								    code_elem.code.push_back(Command(code_elem.label_false, Instruct::NOP));
								    (yyval.valor_lexico)->iloc_code_element = code_elem;
								    }
...
#line 735 "parser.y"
	    ...
	    code_elem.label_true = get_new_label();
	    code_elem.label_false = get_new_label();
	    code_elem.copy_code((yyvsp[-5].valor_lexico)->iloc_code_element.code);
	    code_elem.code.push_back(Command(Instruct::CBR, (yyvsp[-5].valor_lexico)->iloc_code_element.temporary, NO_REG, code_elem.label_true, code_elem.label_false));
	    code_elem.code.push_back(Command(code_elem.label_true, Instruct::NOP));
	    code_elem.copy_code((yyvsp[-2].valor_lexico)->iloc_code_element.code);
	    code_elem.code.push_back(Command(code_elem.label_false, Instruct::NOP));
	    code_elem.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
	    (yyval.valor_lexico)->iloc_code_element = code_elem;
...
#line 758 "parser.y"
                        ...
                        code_elem.copy_code((yyvsp[-2].valor_lexico)->iloc_code_element.code);
                        code_elem.code.push_back(Command(Instruct::CBR, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, NO_REG, code_elem.label_true, code_elem.label_false));
                        code_elem.code.push_back(Command(code_elem.label_true, Instruct::NOP));
                        code_elem.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
...
#line 783 "parser.y"
                            ...
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::OR, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));

			    (yyval.valor_lexico)->x86_code_element = x86::CodeElement{};
		    	    (yyval.valor_lexico)->x86_code_element.code = (yyvsp[-2].valor_lexico)->x86_code_element.code;
		      	    (yyval.valor_lexico)->x86_code_element.copy_code((yyvsp[0].valor_lexico)->x86_code_element.code);
			    auto op1 = (yyvsp[-2].valor_lexico)->x86_code_element.temp_reg_id;
			    auto op2 = (yyvsp[0].valor_lexico)->x86_code_element.temp_reg_id;
			    (yyval.valor_lexico)->x86_code_element.temp_reg_id = op2;
			    (yyval.valor_lexico)->x86_code_element.code.push_back(x86::Command("or", x86_control.reg_as_atnt(op1), x86_control.reg_as_atnt(op2), false));
			    x86_control.free_reg(op1);
                        }
...
#line 809 "parser.y"
                            ...
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::AND, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
			    ...
			    auto op2 = (yyvsp[0].valor_lexico)->x86_code_element.temp_reg_id;
			    (yyval.valor_lexico)->x86_code_element.temp_reg_id = op2;
			    (yyval.valor_lexico)->x86_code_element.code.push_back(x86::Command("and", x86_control.reg_as_atnt(op1), x86_control.reg_as_atnt(op2), false));
			    x86_control.free_reg(op1);
                        }
...
#line 836 "parser.y"
                            ...
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::CMP_EQ, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
...
#line 878 "parser.y"
                            ...
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::CMP_NE, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
...
#line 922 "parser.y"
                            ...
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::CMP_LT, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
...
#line 958 "parser.y"
                            ...
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::CMP_GT, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
...
#line 994 "parser.y"
                            ...
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::CMP_LE, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
...
#line 1030 "parser.y"
                            ...
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::CMP_GE, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
...
#line 1069 "parser.y"
                            ...
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::ADD, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
                            ...
                            auto op2 = (yyvsp[0].valor_lexico)->x86_code_element.temp_reg_id;
                            (yyval.valor_lexico)->x86_code_element.temp_reg_id = op2;
                            (yyval.valor_lexico)->x86_code_element.code.push_back(x86::Command("add", x86_control.reg_as_atnt(op1), x86_control.reg_as_atnt(op2), false));
                            x86_control.free_reg(op1);
...
#line 1104 "parser.y"
                                ...
                                (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                                (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                                (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::SUB, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
                                ...
                                auto op2 = (yyvsp[0].valor_lexico)->x86_code_element.temp_reg_id;
                                (yyval.valor_lexico)->x86_code_element.temp_reg_id = op2;
                                (yyval.valor_lexico)->x86_code_element.code.push_back(x86::Command("sub", x86_control.reg_as_atnt(op1), x86_control.reg_as_atnt(op2), false));
                                x86_control.free_reg(op1);
                            }
...
#line 1140 "parser.y"
                            ...
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::MULT, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
                            ...
                            auto op2 = (yyvsp[0].valor_lexico)->x86_code_element.temp_reg_id;
                            (yyval.valor_lexico)->x86_code_element.temp_reg_id = op2;
                            (yyval.valor_lexico)->x86_code_element.code.push_back(x86::Command("mul", x86_control.reg_as_atnt(op1), x86_control.reg_as_atnt(op2), false));
                            x86_control.free_reg(op1);
                       }
...
#line 1174 "parser.y"
                            ...
                            (yyval.valor_lexico)->iloc_code_element.copy_code((yyvsp[0].valor_lexico)->iloc_code_element.code);
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command(Instruct::DIV, (yyvsp[-2].valor_lexico)->iloc_code_element.temporary, (yyvsp[0].valor_lexico)->iloc_code_element.temporary, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG));
                            ...
                            auto op2 = (yyvsp[0].valor_lexico)->x86_code_element.temp_reg_id;
                            (yyval.valor_lexico)->x86_code_element.temp_reg_id = op2;
                            (yyval.valor_lexico)->x86_code_element.code.push_back(x86::Command("idiv", x86_control.reg_as_atnt(op1), x86_control.reg_as_atnt(op2), false));
                            x86_control.free_reg(op1);
                        }
...
#line 1208 "parser.y"
                        ...
                        (yyval.valor_lexico)->iloc_code_element = (yyvsp[-2].valor_lexico)->iloc_code_element;
                        (yyval.valor_lexico)->iloc_code_element.temporary = (yyvsp[-2].valor_lexico)->iloc_code_element.temporary;
                        (yyval.valor_lexico)->x86_code_element = (yyvsp[-2].valor_lexico)->x86_code_element;
                        (yyval.valor_lexico)->x86_code_element.temp_reg_id = (yyvsp[-2].valor_lexico)->x86_code_element.temp_reg_id;
                       }
...
#line 1235 "parser.y"
                        ...
                        (yyval.valor_lexico)->iloc_code_element = (yyvsp[0].valor_lexico)->iloc_code_element;
                        (yyval.valor_lexico)->iloc_code_element.temporary = (yyvsp[0].valor_lexico)->iloc_code_element.temporary;
                        (yyval.valor_lexico)->x86_code_element = (yyvsp[-1].valor_lexico)->x86_code_element;
                        (yyval.valor_lexico)->x86_code_element.temp_reg_id = (yyvsp[-1].valor_lexico)->x86_code_element.temp_reg_id;
                        }
...
#line 1256 "parser.y"
                        { (yyval.valor_lexico) = (yyvsp[0].valor_lexico);  (yyval.valor_lexico)->set_node_type((yyvsp[0].valor_lexico)->get_node_type());
                            ...
                            auto old_reg = (yyvsp[0].valor_lexico)->iloc_code_element.temporary;
                            (yyval.valor_lexico)->iloc_code_element.temporary = get_new_register();
                            (yyval.valor_lexico)->iloc_code_element.code.push_back(Command{Instruct::LOAD, old_reg, NO_REG, (yyval.valor_lexico)->iloc_code_element.temporary, NO_REG});
                        }
...
#line 1262 "parser.y"
                  { (yyval.valor_lexico) = (yyvsp[0].valor_lexico); (yyval.valor_lexico)->set_node_type((yyvsp[0].valor_lexico)->get_node_type());
                    int lit_val = std::get<int>((yyval.valor_lexico)->get_token_val());
                    ...
                    (yyval.valor_lexico)->iloc_code_element = iloc_elem;
                    ...
                    (yyval.valor_lexico)->x86_code_element = x86_elem;
                }
